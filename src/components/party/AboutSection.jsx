...
function StatCard({ num, label, lang, delay }) {
  ...
  return (
    ...
    >
      ...
      <div className={`text-sm text-[#111827]/50 tracking-wide ${lang === 'th' ? 'font-kanit' : 'font-inter'}`}>
        {label}
      </div>
    </motion.div>
  );
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-20" ref={ref}>
          ...
          <div className="lg:col-span-7 flex flex-col justify-between">
            ...
            >
              <p className={`text-lg text-[#111827]/70 leading-relaxed mb-8 ${lang === 'th' ? 'font-kanit' : 'font-inter'}`}>
                {c.body1}
              </p>
              <p className={`text-lg text-[#111827]/70 leading-relaxed ${lang === 'th' ? 'font-kanit' : 'font-inter'}`}>
                {c.body2}
              </p>
            </motion.div>
            ...
            <motion.blockquote
              ...
              className={`mt-12 pl-6 border-l-4 border-[#FF6B00] text-xl font-medium text-[#111827] leading-snug italic ${
