...
const navLinks = [
  ...
  { en: 'Leadership', th: 'ผู้นำ', href: '/leadership', type: 'link' },
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-12 flex items-center justify-between h-16 lg:h-20">
        ...
        >
          <span className={`font-inter font-800 text-sm tracking-[0.2em] uppercase transition-colors duration-300 ${
            scrolled ? 'text-[#111827]' : 'text-white'
          }`}>
            CHONCHAI PEOPLE'S
          </span>
          <div className="flex items-center font-kanit font-medium text-xs tracking-widest text-[#FF6B00] mt-0.5">
            <span className="relative inline-block mr-1">
              พรรค
              <span className="absolute inset-x-0 top-[55%] h-[2px] bg-[#FF6B00] transition-transform" />
            </span>
