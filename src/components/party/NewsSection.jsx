    ...
    <div ref={ref} className="relative flex items-center">
      ...
      <div className="w-full grid lg:grid-cols-2 gap-8 lg:gap-16">
        ...
        >
          ...
          <h3 className={`font-inter font-bold text-xl text-[#111827] mb-3 leading-snug group-hover:text-[#FF6B00] transition-colors duration-300 ${lang === 'th' ? 'font-anakotmai' : ''}`}>
            {data.title}
          </h3>

          <p className={`text-sm text-[#111827]/50 leading-relaxed mb-4 ${lang === 'th' ? 'font-anakotmai' : 'font-inter'}`}>
            {data.excerpt}
          </p>

          <button 
            onClick={() => toast.info(lang === 'th' ? 'รายละเอียดข่าวจะเปิดให้บริการเร็วๆ นี้' : 'News details will be available soon.')}
            className="flex items-center gap-2 text-xs font-inter font-semibold text-[#FF6B00] tracking-wide group-hover:gap-3 transition-all duration-300"
          >
        ...
        <div className="grid lg:grid-cols-12 gap-12 mb-20">
          <div className="lg:col-span-5">
            <motion.h2
              ...
              transition={{ duration: 0.7 }}
              className={`font-inter font-black text-5xl text-[#111827] leading-none ${lang === 'th' ? 'font-anakotmai' : ''}`}
          ...
          <div className="lg:col-span-7 flex items-end">
            <motion.p
              ...
              className={`text-xl text-[#111827]/50 ${lang === 'th' ? 'font-anakotmai' : 'font-inter'}`}
            >
              {sub}
            </motion.p>
          </div>
