    ...
    >
      ...
      <main className="w-full relative z-10 pt-32 lg:pt-40">
        ...
        <div className="container mx-auto px-6 mb-16 text-center">
          <h1 
            className="text-4xl md:text-5xl lg:text-6xl font-black uppercase tracking-tight text-transparent bg-clip-text bg-gradient-to-b from-white to-white/60 leading-normal py-2 font-anakotmai"
          >
            {teamName}
          </h1>
          <div 
          ...
          <section className="py-8 lg:py-10">
            <div className="container mx-auto px-6 xl:px-12">
              ...
              <div className="flex flex-wrap gap-4 items-center mb-10 lg:mb-12">
                ...
                <h2 className="text-2xl lg:text-3xl font-bold text-white/95 text-center font-anakotmai">
                  หัวหน้าทีม
                </h2>
                <div className="flex-1 bg-[#FF6B00] h-1.5 rounded-full opacity-60"></div>
              </div>
                ...
                <div className="group flex flex-col w-full max-w-[370px] cursor-pointer text-center items-center">
                  ...
                  <div className="w-full aspect-[2/3] group-hover:scale-105 transition-all duration-500 ease-out relative overflow-hidden rounded-3xl mb-5 shadow-[0_0_30px_rgba(0,0,0,0.8)] group-hover:shadow-[0_0_80px_rgba(255,107,0,0.25)] bg-white/5">
                    <div className="w-full h-full flex items-center justify-center bg-[#1A1F2E]">
                      <span className="text-white/40 font-anakotmai text-sm tracking-widest uppercase">Waiting for photo</span>
                    </div>
                  ...
                  <div className="space-y-1.5 px-2">
                    ...
                    <h3 className="text-2xl lg:text-[28px] font-bold text-white transition-colors duration-300 leading-tight font-anakotmai">
                      {headMember.nameTh} ({headMember.nickname})
        ...
        {regularMembers.length > 0 && (
          <section className="py-12 lg:py-16">
            <div className="container mx-auto px-6 xl:px-12">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-10 lg:gap-12 xl:gap-20 xl:gap-y-15">
                {regularMembers.map((member) => (
                  <div key={member.id}>
                    <div className="group flex flex-col w-full cursor-pointer">
                      ...
                      {/* Text Container */}
                      <div className="space-y-1 sm:space-y-1.5 pl-1">
                        <p className="text-[11px] sm:text-sm lg:text-base font-anakotmai text-[#FF6B00]/90 font-bold transition-colors duration-300 group-hover:text-[#FF6B00]">
                          {member.roleTh}
                        </p>
                        <h3 className="text-lg sm:text-2xl lg:text-[28px] font-bold text-white/90 transition-colors duration-300 group-hover:text-white leading-tight font-anakotmai">
                          {member.nameTh} ({member.nickname})
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 sm:w-5 sm:h-5 ml-1 sm:ml-2 inline-block transition-transform duration-300 group-hover:translate-x-1.5 text-[#FF6B00]">
                            <path d="m9 18 6-6-6-6"></path>
                          </svg>
                        </h3>
                      </div>
